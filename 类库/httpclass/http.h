...
public:
    ...
    //static const char* HTTP_VERSION;            //"HTTP-Version"

    //static const char* REQUEST_LINE;            //"Request-Line"
    //static const char* METHOD;                  //"Method"
    //static const char* REQUEST_URI;             //"Request-URI"

    //static const char* STATUS_LINE;             //"Status-Line"
    //static const char* STATUS_CODE;             //"Status-Code"
    //static const char* REASON_PHRASE;           //"Reason-Phrase"
...
public:
    struct REQUEST_LINE
    {
        ...
        std::map<std::string,std::string> body_param;
